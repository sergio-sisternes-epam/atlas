...
```bash
export ATLAS_ROOT=/absolute/path/to/references/atlas/atlas
export ATLAS_PRESETS="Skill memory:/absolute/path/to/references/atlas/atlas"

python3 scripts/atlas.py view --root /absolute/path/to/references/atlas/atlas --check
```
